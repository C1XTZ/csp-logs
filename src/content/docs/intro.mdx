...
There are currently changelogs are available for **{versionsData.counts.total}** versions, of which **{versionsData.counts.previews}** are previews and **{versionsData.counts.releases}** are public releases.
